...
public:
    ClockRecovery() { estimates_.fill(0); }
     ...
     */
    uint8_t current_index() const { return index_; }
     ...
     * has been called.
     */
    FloatType clock_estimate() const { return clock_; }
     ...
     * has been called.
     */
    uint8_t sample_index() const { return sample_index_; }

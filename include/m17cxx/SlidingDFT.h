 ...
 */
template <typename FloatType, size_t SampleRate, size_t Frequency,
...
class SlidingDFT
{
    ...
    static constexpr FloatType kth =
        FloatType(Frequency) / FloatType(SampleRate);
